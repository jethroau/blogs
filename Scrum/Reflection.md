...
All **Scrum events are time-boxed events**, such that every event has a maximum duration. Once a Sprint begins, its duration is fixed and cannot be shortened or lengthened.    
...
Here is an daily scrum example of what might be used: 
